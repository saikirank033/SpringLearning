...
import com.Spring.SpringLearning.repository.SubmissionRepositoryClass;
...
public class SubmissionRepositoryTest {
    ...
    public void test_addSubmission() throws Exception{
        ...
        SubmissionDTO dto= getSubmission("25-1-2023","virat","java","rahul","kalyan");
        ...
        Assertions.assertEquals("virat",result.getSalesPersonName());
        Assertions.assertEquals("rahul",result.getVendorName());
    ...
    public void test_updateSubmission() throws NoSuchFieldException, IllegalAccessException {
        ...
        SubmissionDTO dto1= getSubmission("25-1-2023","virat","java","alex","kalyan");
        dto1.setId("id-1");
